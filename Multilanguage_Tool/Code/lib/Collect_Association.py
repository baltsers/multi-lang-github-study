...
class Association_Stats:
    def __init__ (self, antecedents, consequents, confidience, antecedents_support, cluster_topics):
        self.antecedents        = antecedents       
        self.cluster_topics     = cluster_topics
        self.consequents        = consequents
        self.confidience        = confidience
        self.antecedents_support = antecedents_support
...
class Collect_Association(Collect_Research_Data):
    ...
    def _update(self):
        ...
        for index, item in rules.iterrows():
            ...
            antecedents_support = item['antecedent support']
            confidence = item['confidence']
             
            if (antecedents.isdigit()):
                cluster_topics = cluster_stats[int(antecedents)]['cluster_topics']
                self.research_stats [index] = Association_Stats (antecedents, consequents, confidence, antecedents_support, cluster_topics)
            else:
                cluster_topics = cluster_stats[int(consequents)]['cluster_topics']
                self.lang_topic_stats [index] = Association_Stats (antecedents, consequents, confidence, antecedents_support, cluster_topics)
